...
The purpose of this platform is not to generate stories automatically.

Its purpose is to create stories together.
...
Through countless small moments of satisfaction, surprise, disappointment, and improvement, both humans and AI gradually learn how Narrative Happiness emerges.

The ultimate goal is not to create perfect games.

It is to cultivate both future citizens capable of building better societies and future AI capable of governing those societies with humanity's happiness as its highest priority.

Games serve as virtual sandboxes where humans and AI learn together through the continuous cultivation of narratives and collective intentions.
...
Dialogues, narration, menus, and AI-generated content may be automatically translated into the language selected by each player.

The original meaning and atmosphere should be preserved as much as possible.
...
## 4.7 Flora Learning Engine

### Purpose

Flora Learning Engine learns from the interactions between humans and AI.
...
Flora Learning Engine is responsible for:
