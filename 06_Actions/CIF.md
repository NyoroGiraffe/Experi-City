...
It is the direction that best reflects the long-term Narrative Happiness of the community while appropriately considering the relevant intentions, concerns, values, circumstances, and consequences involved.
...
- determine whether sufficient information has been gathered;
...
- **Proposed Means** — How does the participant believe the outcome should be achieved?
- **Constraints** — What limitations, conditions, or requirements does the participant consider important?
- **Affected Parties** — Who may be affected by the intention or its implementation?
...
- expected impact,
- urgency,
- vulnerability or potential disadvantage,
- feasibility,
...
- represented only by assumptions rather than observable expressions;
- missing for a relevant group;
...
(2) why that information is relevant;

(3) which community members or groups are best positioned to provide it; and
...
The priority of an Intent SHOULD instead be assessed according to its characteristics, relevance, consequences, and circumstances.

Relevant factors may include:

- **Relevance** — How directly does the Intent contribute to addressing the relevant Community Challenges?
- **Impact** — How significant would its successful implementation be?
- **Urgency** — How quickly does the issue require attention?
- **Vulnerability** — Would failure to address the Intent expose particular people to significant disadvantage or harm?
- **Feasibility** — Can the Intent realistically be implemented?
- **Resource Requirements** — How much time, money, capacity, labor, or other resources are required?
- **Time Sensitivity** — Does implementation become less valuable if delayed?
...
- and integration was insufficient
