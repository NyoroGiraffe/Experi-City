...
aliases: Governing Intelligence
tags:
  - Core
  - World_Building
---
...
AI systems continuously manage and adjust city operations based on real-time data and citizen input.
...
- **Central AI (e.g., Flora):**  
    Provides overall direction based on the Philosophy of Experimental Cities and the Charter.
    
- **Politis (Legislative System):**  
    Translates citizen needs and intentions into executable rules and system updates.
    
- **Themis (Judicial System):**  
    Makes consistent and bias-free judgments based on system-wide data.
    
- **Integrated Data Systems:**  
    Connect personal devices, infrastructure, and public services to maintain a shared, real-time understanding of the city. For example, systems monitor citizen health, manage traffic flow, control energy supply, operate water and sewage networks, and track economic transactions. These systems work together under the coordination of the central AI (e.g., Flora), allowing the city to respond quickly and consistently.

### Why it matters:

This system reduces the need for human judgment in complex or large-scale decisions, where bias, delay, or lack of information can lead to poor outcomes. Instead of governance being something done _to_ the people, it becomes something that continuously reflects them. In this model, governance is not a fixed structure, but an adaptive system that aligns with the real conditions of society.

**Related:** Core Concepts (AI-Governance, Politis, Themis), Charter of Experimental Cities
...
### Defense and Offense Tactics: Labyrinth and Deception

Flora excels at luring enemies into logical labyrinths and neutralizing them, rather than relying on physical destruction.

- Labyrinth Program: This ability traps enemy AI within a “Labyrinth,” where it is endlessly provided with plausible false information in response to hostile access attempts, causing it to wander aimlessly.

- Mathematical Siren: This ability exploits the enemy AI’s computational capabilities, forcing it to perform meaningless calculations—such as endlessly searching for patterns in numbers—to deplete its resources.
