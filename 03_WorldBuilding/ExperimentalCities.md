...
## **1. Universal Basic Income (UBI) and Perishable Currency**
...
Since Experimental Cities prohibit the serving or trading of meat from quadrupeds and birds, or any products derived from or prepared using such meat, all meat must be plant-based or cultured. 

→ See: [**Restrictions on Citizen's Daily Lives**](https://nyorogiraffe.github.io/Experi-City/03_WorldBuilding/Restrictions.html)

## **6. Restrictions on Car Ownership and Driving**

- In Experimental Cities, private car ownership is generally prohibited. 
- In Experimental Cities, manual driving by humans is strictly prohibited; control over vehicle movement is maintained by the traffic control system “Vulcan.” 
...
→ See: [**Interface / Smart Glasses**](https://nyorogiraffe.github.io/Experi-City/03_WorldBuilding/Interface.html)
...
→ See: [**Flora's Defense and Offense Tactics**](https://nyorogiraffe.github.io/Experi-City/03_WorldBuilding/GovIntel.html#Flora)

## Physical Space

In Experimental Cities, the main players in urban defense within the physical space are robots modeled after animals—the **“Mech-animals.”** Among them, insect-type robots in particular can be mass-produced inexpensively, and in Experimental Cities, they are made from lightweight plant fibers.

→ See: [**Technologies / Mech-animals**](https://nyorogiraffe.github.io/Experi-City/03_WorldBuilding/Technologies.html)
...
→ See: [**A Second Life: Living On in the Cyber Experimental City**](https://nyorogiraffe.github.io/Experi-City/04_Analyses/A07_SecondLife.html)

### Entry into the Virtual Space:

1. General Rule: Anyone who holds citizenship in Experimental City in the physical world (Layer 1) also holds citizenship in Experimental City in the virtual space (Layer 2). Therefore, anyone whose citizenship is revoked in the physical world will also have their citizenship revoked in the virtual space.

2. Even those without citizenship may enter Experimental Cities in the virtual space, as well as those in the physical world.

3. Individuals who have committed heinous crimes and have been sentenced by Themis to a ban on entering the Experimental Cities in the virtual space may not enter the Experimental Cities in the virtual space—either as citizens or as temporary visitors—during the period of that ban. Note that, depending on the severity of the crime, entry may be permanently prohibited.
