...
Experimental Cities operate under a strict principle: every unit of farmland exists to feed people. The cities prohibit the trade in animal meat and animal-derived products, precisely because raising animals for food consumes disproportionate land and resources relative to the calories produced. The same logic applies, even more directly, to fuel crops. Devoting scarce agricultural land to energy corn or oil palms while residents depend on that same land for their food supply is a contradiction the cities are not willing to accept.

Importing biomass from outside defeats the self-sufficiency principle entirely. Harvesting the city's own trees at scale depletes a resource that takes decades to regenerate. Biomass therefore has a legitimate but limited role: agricultural residues, aquaponics waste, and food-processing byproducts can fuel a biogas system that contributes meaningfully to thermal energy and modest electricity generation. But it cannot be the primary electrical power source.

This is the constraint that forces Experimental Cities to look elsewhere.
...
The design constraint, however, is not average demand. It is peak demand.

On the hottest summer evenings and coldest winter nights, demand reaches approximately 700 to 900 MW — roughly 1.7 to 1.8 times the annual average. Solar output is zero at night and severely reduced on overcast days. Wind is intermittent by nature. To bridge the gap between renewable output and peak demand without a stable baseload source, a city would need massive battery storage. And battery storage, at the scale required for a city of this size, depends on lithium, cobalt, and other rare-earth materials — the exact category of outside resource that Experimental Cities are built to avoid.

Renewables are indispensable. They are not sufficient.
...
The answer is nuclear power — specifically, a Small Modular Reactor serving as the city's stable baseload source through the night and during peak demand.

For most cities, this answer would end the conversation before it began. Nuclear infrastructure near residential areas triggers protest, political gridlock, and planning processes that stretch across decades. Public trust in nuclear technology remains fragile in much of the world, and for understandable reasons.

Experimental Cities are different by design. Their residents have made an active, informed choice to live inside a social experiment. They accept infrastructure arrangements — and the associated risks — that would be politically impossible in an ordinary city. A Small Modular Reactor located within or adjacent to the urban boundary is not a surprise imposed on an unwilling population. It is a known feature of the city that residents chose when they chose to live there.

This is not a minor point. It is the condition that makes the entire energy solution possible.
...
A 2022 study published in the _Proceedings of the National Academy of Sciences_ found that most current light-water SMR designs generate more radioactive waste per unit of electricity than conventional large reactors, in some cases considerably more. For cities committed to long-term resource responsibility, adopting a reactor that worsens the waste problem would be indefensible.

The answer is a **fast-spectrum SMR**. Unlike light-water designs, fast-spectrum reactors can run on Mixed Oxide (MOX) fuel — processed from other nations' spent nuclear fuel — and in doing so reduce the long-term radiotoxicity of that material rather than simply adding to it. The city receives what every nuclear nation currently treats as a liability, extracts its remaining energy value, and returns a smaller, less hazardous waste volume.

The economic logic is equally sound. Nations holding spent fuel face ongoing storage costs running into the billions. An Experimental City that accepts their material — already processed into MOX pellets by established facilities in France, the United Kingdom, or Russia — provides a genuine service, and is in a position to receive that fuel at low or negative cost. A multi-year supply of MOX pellets occupies a small physical footprint and requires no ongoing extraction of new materials. The supply chain is periodic, low-volume, and strategically stockpileable — consistent with self-sufficiency rather than in conflict with it.

One fast-spectrum SMR unit of 300 to 400 MW, monitored continuously by Flora's AI governance systems, covers peak demand when solar and wind output is low and provides uninterrupted baseload through the night. Flora's real-time transparency — radiation levels, reactor status, fuel inventory, all visible to every resident through the same platform that governs other city functions — replaces the institutional opacity that makes nuclear power contentious elsewhere.
...
In the event of a main grid failure, these systems continue without interruption. The microreactors are not intended to power the city. They are intended to ensure that the city's essential functions survive any disruption to the main grid.
